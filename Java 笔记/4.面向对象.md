...
在定义类的成员变量时**可以同时赋予初值**，表明类所创建的对象的初始状态
...
![image-20240926204644711](http://sjg9t98lf.hn-bkt.clouddn.com/202409262046493.png)
...
1. 类声明时，如果关键字class前面加上public关键字，就称这样的类是一个public类
